...
ServerEvents.recipes(event => {
	...
	//deploy dirt on path to make dirt; deployed dirt is not consumed
	event.recipes.create.deploying('dirt', ['dirt_path', 'dirt']).keepHeldItem()
	//press coarse dirt to make path
	event.recipes.create.pressing('dirt_path', 'coarse_dirt')
